...
int main(int argc, char *argv[]) {
	...
	printf("open1:\n");
    int fd;
    if ((fd = fsOpen("foo/level1/level2/file1.txt", 0)) < 0) {
	...
	//printf("open2:\n");
 //   int fd2;
 //   if ((fd2 = fsOpen("foo/file2.txt", 0)) < 0) {
 //       perror("fsOpen"); exit(1);
 //   }
	//printf("fd2: %d\n", fd2);
 ...
 //   }
    ...
    *((char *) buf + bytesread) = '\0';
	...
	printf("openDir:\n");
	FSDIR* tempFsDir=fsOpenDir("foo/level1/level2/");
	if(tempFsDir==NULL)
	{
